...
class modelo_Ponente(models.Model):
    ...
    Hora_Ponencia = models.CharField(choices=HORA_CHOICES,max_length=20,default='0', help_text='Hora De La Ponencia.', unique='true')
...
class modelo_Asistente(models.Model):
    ...
    Asistir_Ponencia = models.ForeignKey(modelo_Ponente, on_delete=models.CASCADE, help_text='Ponencia A Asistir.')
